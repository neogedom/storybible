...
Kate é o **pé no chão** da história. Enquanto Mário questiona o sentido do
universo e Nolan calcula variáveis, Kate age. Ela não tem tempo para filosofia
— tem uma faca e um problema para resolver.

## Aparência Canônica

- **Idade aparente**: 25–32
- **Cabelo**: longo, escuro (comprimento persistente — não alterar)
...
- #3E2F2C (marrom escuro)
- #5A4330 (couro)
- #7B6A4F (bege sujo)
- #2F4B39 (verde musgo)
- #B86B2E (âmbar de tocha)

## Regras de Variação

- **Permitido**: sujeira, manchas de sangue não gráficas, rasgos na roupa,
