...
| Acessórios | Documentos/livros, selo oficial |
...
`Nolan, cabelo grisalho bem cortado, pele clara sem imperfeições, postura ereta e rígida, [roupas do capítulo], expressão de [emoção], iluminação [tipo], fundo [descrição] — tons #3D3D3D, #E8DCC8, #C0C0C0, #1A1A2E, #8B7355`
