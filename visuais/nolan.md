---
type: VisualState
title: Nolan — Timeline Visual
character: Nolan
tags: [visual, timeline, nolan]
...
- **Objeto**: três cartas seladas; cavalo (carroça danificada — o que restou da carruagem do comboio, capota comida pelo fogo no incêndio; a roda é emendada na Feira de Tronk, de onde sai a volta à Metrópole — decisão 2026-09-18)
...
## Prompt de Imagem (modelo)

`Nolan, cabelo grisalho bem cortado, pele clara sem imperfeições, óculos, postura ereta e rígida, [roupas do capítulo], expressão de [emoção], iluminação [tipo], fundo [descrição] — tons #3D3D3D, #E8DCC8, #C0C0C0, #1A1A2E, #8B7355`
