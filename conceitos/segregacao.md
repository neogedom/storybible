...
type: Concept
title: Segregação
description: Política de separação entre humanos e leviantares, idealizada por Nolan e implementada por Genocydo.
tags: [conceito, segregacao, politica, nolan]
...
A Segregação foi **idealizada por Nolan** (trauma pessoal: seu pai contraiu
...
- Humanos endividados enviados à Mina de Quartzo como trabalho forçado
...
Ornick. A mensagem de igualdade radical do evangelho de Mário é uma ameaça
direta a esse sistema.

## Conexões

- [Nolan](/personagens/nolan.md) — Idealizador (trauma do pai)
- [Genocydo](/personagens/genocydo.md) — Implementador
- [Mário](/personagens/mario.md) — A mensagem dele ameaça o sistema
