...
sementes:
  - Raiva de Mário contra Deus (identificação irada) → germina no cap. 27
  - Manto de Tharin recuperado (chekhov's gun disparada)
  - Mina de Quartzo plantada como destino (cap. 23)
  - "Com quem você estava falando?" — gancho da glossolalia (Kate)
  - "Como continuar falando com ele" — pergunta suprimida (cap. 27)
---
...
amanhecer/Mina foi movido para a abertura do cap. 23 (rascunho intermediário excluído; conteúdo absorvido).

## Personagens

### Mário

- POV. Febril, ferida no ombro infectada (ch20)
...
- Ombro direito ferido (ch20); manto de xilomagia nos ombros

### Lakand

- Guia a fuga; confirma o padrão da ronda (instinto de caçador)
- "Tom de luto" — Saramant queimando
- Tensão silenciosa com Kate (dívida do ch20, "eu perdi")
...
- Raiva de Mário contra Deus (identificação irada) → cap. 27 (enquadrada)
...
- "O que não sabia era como continuar falando com ele" — pergunta suprimida (cap. 27)

## Conexões

- [Cap. 20](/capitulos/capitulo-20.md) — fuga, manto, gancho da glossolalia
- [Cap. 13](/capitulos/capitulo-13.md) — fluência habilitada (ditado na mente)
- [Cap. 1](/capitulos/capitulo-01.md) — rapaz da calçada (cobrança de dívida)
- [Cap. 27](/temas/esquema-l1.md) — enquadrada pela raiva (futuro)
...
- [Glossolalia](/decisoes/glossolalia-invertida-oracao-cap20.md)
