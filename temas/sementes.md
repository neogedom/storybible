---
type: Theme
title: Mapa de Sementes Cross-Livro
description: Registro do que precisa ser plantado no L1 para colher no L2.
tags: [tema, sementes, cross-livro, L1, L2]
timestamp: 2026-07-24T12:00:00-03:00
---

# Mapa de Sementes Cross-Livro
...
- **Ironia**: Devour governava pela brutalidade; Nolan governa pela burocracia.
  O mesmo castelo chamuscado, os mesmos autômatos — mas agora com justificativa
  moral.
...
- **Efeito**: cria uma **dívida** que Kate (que odeia dever) nunca pediu;
  ...
  justo demais").
- **Germinação**: L2 — o distanciamento que culmina na aliança de Lakand com
  Benjamim contra o reino de Mário.
...
## 14. A Dívida de Sangue — Kate matou um filho de Devour
